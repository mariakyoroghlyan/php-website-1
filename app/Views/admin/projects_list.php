    ...
    <div class="card py-lg-15 px-lg-15 min-w-100">
        <div class="d-flex flex-stack flex-wrap mb-5">
            ...
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" data-kt-docs-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Projects">
            </div>
            <!--end::Search-->
            <!--begin::Toolbar-->
                ...
                <div class="table-responsive">
                    <table id="kt_datatable_zero_configuration" class="table table-row-bordered gy-5 dataTable no-footer" aria-describedby="kt_datatable_zero_configuration_info">
                        ...
                        <tr class="even">
                            ...
                            <td>
                                <div class=" <?=  $project['show'] == 1 ? 'badge badge-light-success' : 'badge badge-light-danger'?>"><?= $project['show'] == 1 ? 'Active' : 'Inactive' ?></div></td>
                            <td><?= $project['category'] ?></td>
                            <td>
                                <?= strlen($project['information']) > 15 ? esc(substr($project['information'], 0, 15)) . '...' : esc($project['information']) ?>
                            </td>
                            <td>
                                <a href="/admin/edit_project?id=<?= $project['id'] ?>" class="btn btn-sm btn-success">Edit</a>
                                <a href="/admin/deleteProject?id=<?= $project['id'] ?>" class="btn btn-sm btn-danger">Delete</a>
                            </td>
                        </tr>
                        <?php endforeach ?>
