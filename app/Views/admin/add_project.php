    ...
    <div class="card min-w-100 py-lg-15 px-lg-15">
        ...
        <form method="post" enctype="multipart/form-data" id="add_projects">
            ...
            <div class="mb-10">
                ...
                <input type="text" id="location" name="location" class="form-control form-control-solid" placeholder="Location">
            </div>
            ...
            <div class="mb-10">
                ...
                <input type="number" step="0.01" id="square" name="square" class="form-control form-control-solid" placeholder="Square">
            </div>
            ...
            <div class="mb-10 mt-14 mb-4 d-flex justify-content-between align-items-center">
                ...
                <span style="font-size:2.05rem; cursor: pointer" class="createPublications">+</span>
            </div>
...
<script>
    ...
    <select id="team[${timestamp}][position]" name="team[${timestamp}][position]" class="form-control form-control-solid">
                    ...
                    <div class="d-flex gap-2 delete_line">
                         <div class="w-50">
                                <label for="material[${timestamp}][collection_name]" class="required form-label mt-7 mb-4">
                                 ...
                                 <input type="text" id="material[${timestamp}][collection_name]" name="material[${timestamp}][collection_name]" class="form-control form-control-solid" placeholder="Title">
                          </div>

                          <div class="w-50">
                                <label for="material[${timestamp}][value]" class="required form-label mt-7 mb-4">
                                     Information
                                </label>
                                <input type="text" id="material[${timestamp}][value]" name="material[${timestamp}][value]" class="form-control form-control-solid" placeholder="Information">
                           </div>
                           <div class="remove-row" style="align-self: end" >
                                 <span class="btn btn-danger remove-row" >x</span>
                           </div>
        ...
        $('.createPublications').click(function () {
            let timestamp = Date.now();

            $('.appendPublications').append(`
                    <div class="d-flex gap-2 delete_line">
                        <div class="w-100">
                                <label for="publication[${timestamp}][name]" class="required form-label mt-7 mb-4">
                                     Title
                                 </label>
                                 <input type="text" id="publication[${timestamp}][name]" name="publication[${timestamp}][name]" class="form-control form-control-solid" placeholder="Title">
                         </div>
                         <div class="w-100">
                                <label for="publication[${timestamp}][link]" class="required form-label mt-7 mb-4">
                                     Link
                                 </label>
                                 <input type="text" id="publication[${timestamp}][link]" name="publication[${timestamp}][link]" class="form-control form-control-solid" placeholder="Link">
                          </div>
