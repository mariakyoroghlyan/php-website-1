        ...
        <form method="post" enctype="multipart/form-data" id="add_awards_and_media">
            ...
            <div class="d-flex gap-2 delete_line">
                <div class="w-100">
                    ...
                    <input type="text" id="link_name" name="link_name" class="form-control form-control-solid" placeholder="Link name">
                </div>
                <div class="w-100">
                    <label for="link" class=" form-label mt-7 mb-4">
                        Link
                    </label>
                    <input type="text" id="link" name="link" class="form-control form-control-solid" placeholder="link">
                </div>
